...
public class PartidaService{
    ...
    @Autowired
    private JpaClubesRepository clubeRepository;
    ...
    public JpaClubesRepository getClubeRepository() {
        return clubeRepository;
    }

    public void setClubeRepository (JpaClubesRepository jpaClubesRepository) {
        this.clubeRepository = jpaClubesRepository;
    }
